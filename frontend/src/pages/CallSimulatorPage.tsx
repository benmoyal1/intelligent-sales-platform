...
export default function CallSimulatorPage() {
  ...
  if (!call) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-gray-400">Loading call...</div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto">
      {/* Header */}
      <div className="bg-dark-card rounded-lg shadow mb-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-100">{call.prospect_name}</h1>
      ...
      <div className="grid grid-cols-3 gap-6">
        {/* Chat Interface */}
        <div className="col-span-2 bg-dark-card rounded-lg shadow flex flex-col" style={{ height: '600px' }}>
          {/* Messages */}
          ...
          <div className="border-t border-dark-border p-4">
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-dark-border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-dark-hover text-gray-100 placeholder-gray-500"
                disabled={sending}
              />
              <button
        ...
        <div className="bg-dark-card rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-100 mb-4">Real-time Analysis</h2>

          {analysis ? (
            <div className="space-y-4">
              <div>
                <div className="text-sm font-medium text-gray-300 mb-2">Sentiment</div>
              ...
              <div>
                <div className="text-sm font-medium text-gray-300 mb-2">Qualification Status</div>
                <div className="text-sm text-gray-100 bg-dark-hover p-2 rounded">
                  {analysis.qualification_status}
                </div>
              </div>

              <div>
                <div className="text-sm font-medium text-gray-300 mb-2">Recommended Action</div>
                <div className="text-sm text-gray-100 bg-dark-hover p-2 rounded">
              ...
              <div>
                <div className="text-sm font-medium text-gray-300 mb-2">Conversation Stats</div>
